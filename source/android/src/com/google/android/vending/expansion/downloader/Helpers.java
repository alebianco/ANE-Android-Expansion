    ...
    static public int getDownloaderStringResourceIDFromState(Context ctx, int state) {
        switch (state) {
            case IDownloaderClient.STATE_IDLE:
                return ctx.getResources().getIdentifier("state_idle", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_FETCHING_URL:
                return ctx.getResources().getIdentifier("state_fetching_url", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_CONNECTING:
                return ctx.getResources().getIdentifier("state_connecting", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_DOWNLOADING:
                return ctx.getResources().getIdentifier("state_downloading", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_COMPLETED:
                return ctx.getResources().getIdentifier("state_completed", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_PAUSED_NETWORK_UNAVAILABLE:
                return ctx.getResources().getIdentifier("state_paused_network_unavailable", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_PAUSED_BY_REQUEST:
                return ctx.getResources().getIdentifier("state_paused_by_request", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_PAUSED_WIFI_DISABLED_NEED_CELLULAR_PERMISSION:
                return ctx.getResources().getIdentifier("state_paused_wifi_disabled", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_PAUSED_NEED_CELLULAR_PERMISSION:
                return ctx.getResources().getIdentifier("state_paused_need_cellular_permission", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_PAUSED_ROAMING:
                return ctx.getResources().getIdentifier("state_paused_roaming", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_PAUSED_NETWORK_SETUP_FAILURE:
                return ctx.getResources().getIdentifier("state_paused_network_setup_failure", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_PAUSED_SDCARD_UNAVAILABLE:
                return ctx.getResources().getIdentifier("state_paused_sdcard_unavailable", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_FAILED_UNLICENSED:
                return ctx.getResources().getIdentifier("state_failed_unlicensed", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_FAILED_FETCHING_URL:
                return ctx.getResources().getIdentifier("state_failed_fetching_url", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_FAILED_SDCARD_FULL:
                return ctx.getResources().getIdentifier("state_failed_sdcard_full", "string", ctx.getPackageName());
            case IDownloaderClient.STATE_FAILED_CANCELED:
                return ctx.getResources().getIdentifier("state_failed_cancelled", "string", ctx.getPackageName());
            default:
                return ctx.getResources().getIdentifier("state_unknown", "string", ctx.getPackageName());
        }
    }
}
