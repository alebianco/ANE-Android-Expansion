...
public class DownloadNotification implements IDownloaderClient {
    ...
    public void onDownloadStateChanged(int newState) {
        ...
        if (newState != mState) {
            ...
            switch (newState) {
                case 0:
                    iconResource = mContext.getResources().getIdentifier("stat_sys_warning", "drawable", "android");
                    stringDownloadID = mContext.getResources().getIdentifier("state_unknown", "string", mContext.getPackageName());
                    ongoingEvent = false;
                    break;

                case IDownloaderClient.STATE_DOWNLOADING:
                    iconResource = mContext.getResources().getIdentifier("stat_sys_download", "drawable", "android");
                ...
                case IDownloaderClient.STATE_CONNECTING:
                    iconResource = mContext.getResources().getIdentifier("stat_sys_download_done", "drawable", "android");
                    stringDownloadID = Helpers.getDownloaderStringResourceIDFromState(mContext, newState);
                    ongoingEvent = true;
                    break;
    ...
    public void onDownloadProgress(DownloadProgressInfo progress) {
        ...
        if (progress.mOverallTotal <= 0) {
            ...
            mNotification.icon = mContext.getResources().getIdentifier("stat_sys_download", "drawable", "android");
            ...
            mCustomNotification.setIcon(mContext.getResources().getIdentifier("stat_sys_download", "drawable", "android"));
